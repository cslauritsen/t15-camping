...
pub async fn get_v1_events(configuration: &configuration::Configuration, x_partner_token: &str, x_user_token: &str, start_on: &str, end_on: &str) -> Result<models::event_entity::EventsResponse, Error<GetV1EventsError>> {
